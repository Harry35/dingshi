 ...
 */
define("WECHAT_URL", 'http://dingshi8.com/iDeliveryFood/wechat.php');
define('WECHAT_TOKEN', 'parislivraisonwok');
define('ENCODING_AES_KEY', "Lje3XguyOEq2Z2c3vH8nBCDvRRsUS5Zz1SJT3wXtDm1");

/*
 * 开发者配置
 */
define("WECHAT_APPID", 'wxe14777ffecd2953c');
define("WECHAT_APPSECRET", '107c40ad32d1ff68d7e45f852d3ded24');

//define("BASE_URL", 'http://'.$_SERVER['SERVER_NAME'].'/iDeliveryFood');
define("BASE_URL", 'http://www.dingshi8.com/iDeliveryFood');
// define("BASE_URL", 'http://'.$_SERVER['SERVER_NAME'].'/~xu/iDeliveryFood');
